...
StripeResponseIntent stripeResponseIntentFromJson(String str) =>
    StripeResponseIntent.fromJson(json.decode(str));

String stripeResponseIntentToJson(StripeResponseIntent data) =>
    json.encode(data.toJson());

class StripeResponseIntent {
  StripeResponseIntent({
    this.id,
    this.object,
  ...
  factory StripeResponseIntent.fromJson(Map<String, dynamic> json) =>
      StripeResponseIntent(
        id: json["id"],
        object: json["object"],
        allowedSourceTypes:
            List<String>.from(json["allowed_source_types"].map((x) => x)),
        amount: json["amount"],
